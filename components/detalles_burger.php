...
<div class="bg-neutral-800 rounded-xl shadow-xl text-white mt-8 mb-8 p-8 max-w-6xl mx-auto flex flex-col lg:flex-row gap-10">
        <!-- Imagen -->
        ...
        <?php else: ?>
            <!-- Usuario sin sesión -->
            <div class="mt-6 max-w-md mx-auto p-6 border border-black bg-neutral-950 rounded-lg text-center shadow-sm">
                <h3 class="text-lg font-semibold text-white mb-3">¿Has probado esta burger?</h3>
                <p class="text-white mb-5">Inicia sesión para marcarla como probada y darle una puntuación.</p>
                <div class="flex justify-center gap-4">
                    <a href="login.php" class="px-4 py-2 bg-zinc-700 text-white rounded hover:bg-amber-400 transition">Login</a>
                    <a href="registro.php" class="px-4 py-2 bg-zinc-700 text-white rounded hover:bg-amber-400 transition">Registro</a>
                </div>
            </div>
