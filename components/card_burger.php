...
<a href="detalle_burger.php?id=<?= htmlspecialchars($burger['id']) ?>" class="bg-neutral-800 rounded-xl overflow-hidden shadow-lg hover:shadow-amber-400 transition-shadow">
